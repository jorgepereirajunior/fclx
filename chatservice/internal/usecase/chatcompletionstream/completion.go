...
import (
	...
	"github.com/jorgepereirajunior/fclx/chatservice/internal/domain/entity"
	"github.com/jorgepereirajunior/fclx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	assistance, err := entity.NewMessage("assistance", fullResponse.String(), chat.Config.Model)
	if err != nil {
		return nil, errors.New("error creating assistance message: " + err.Error())
	}
